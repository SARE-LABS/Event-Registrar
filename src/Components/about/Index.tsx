...
export const About = () => {
  return (
    <div className="w-full h-max flex flex-col mt-12 gap-4">
      <h1 className="font-bold w-max text-[28px] before:w-[75%] before:h-[4px] before:rounded-full before:bg-[#67B5DC] relative before:absolute before:top-[100%]">About the Event</h1>
