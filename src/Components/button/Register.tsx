...
export const RegisterButton = () => {
  ...
  return (
    <div 
      onClick={openModal}
      className="bg-[#67B5DC] hover:bg-[#5BA7CE] ease-in-out duration-300 cursor-pointer text-white py-2 md:px-6 px-12 rounded-full flex items-center font-medium gap-1"
    >
