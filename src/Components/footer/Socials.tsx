...
export const Social = () => {
  ...
  <mask id="lineMdYoutubeFilled0">
    <g fill="none" fillOpacity="0" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
      <path fill="#fff" strokeDasharray="64" strokeDashoffset="64" d="M12 5c9 0 9 0 9 7c0 7 0 7 -9 7c-9 0 -9 0 -9 -7c0 -7 0 -7 9 -7Z">
  ...
  <rect width="24" height="24" fill="url(#gradYouTube)" mask="url(#lineMdYoutubeFilled0)"/>
</svg>
